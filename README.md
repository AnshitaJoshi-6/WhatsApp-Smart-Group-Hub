...
* **Smart Summary ("What did I miss?"):** Instantly digests dozens of unread messages into a clean summary of critical updates.
* **Auto-Updated Assignment Tracker:** Automatically detects teacher corrections (e.g., assignment deadlines changing from Friday to Monday) and updates tracking cards.
* **Exams & Deadlines Hub:** Centralizes upcoming assessments with direct shortcuts back to the original chat context.
...
2. Start on the Chat screen (Biology Class 2026)
3. Tap the Hub icon in the top header
